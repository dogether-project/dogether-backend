...
export const GROUP_PER_MEMBER_COUNT = 5;  // 회원당 참여 그룹 수
...
export const PAST_ONE_CYCLE_PER_GROUP_COUNT = MEMBER_COUNT / MEMBER_PER_GROUP_COUNT * GROUP_PER_MEMBER_COUNT;   // 한 사이클에 존재하는 그룹 개수
export const PAST_TOTAL_DAILY_TODO_CERTIFICATION_COUNT = MEMBER_COUNT * DAY_TODO_CERTIFICATION_PER_MEMBER_COUNT * PAST_GROUP_RUNNING_DAY * GROUP_PER_MEMBER_COUNT * PAST_TOTAL_ACTIVITY_CYCLE;


// CSV 파일 옵션
export const PAST_ACTIVITY_DATA_BASE_PATH = './csv/past-activity-data';
export const CURRENT_ACTIVITY_DATA_BASE_PATH = './csv/current-activity-data';
...
/**
 * CSV 파일 Stream Flush 대기 Util
 */
export function waitForStreamFinish(stream) {
