...
export const TOTAL_PAST_ACTIVITY_DAY = 365;  // 총 과거 진행일 수
export const TOTAL_PAST_ACTIVITY_CYCLE = Math.ceil(TOTAL_PAST_ACTIVITY_DAY / PAST_GROUP_RUNNING_DAY);
export const PAST_GROUP_ACTIVITY_START_AT = getDateNDaysAgo(TOTAL_PAST_ACTIVITY_CYCLE * PAST_GROUP_RUNNING_DAY + CURRENT_GROUP_RUNNING_DAY);
