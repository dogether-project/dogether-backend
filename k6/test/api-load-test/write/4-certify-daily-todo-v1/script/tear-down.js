...
import {
    deleteAllDailyTodoCertificationByMember,
    deleteAllDailyTodoCertificationReviewerByMember
...
async function tearDown() {
    ...
    try {
        ...
        await deleteAllDailyTodoCertificationReviewerByMember(connection, targetMemberIds);
        await deleteAllDailyTodoCertificationByMember(connection, targetMemberIds);
